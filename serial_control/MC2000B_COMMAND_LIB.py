...
DLL_PATH = os.path.join(MODULE_DIR, "MC2000CommandLibWin32.dll")
if not os.path.exists(DLL_PATH):
    raise FileNotFoundError(
        f"Missing MC2000 DLL at: {DLL_PATH}. "
        "Ensure MC2000CommandLibWin32.dll is next to this module."
    )

#region import dll functions
MC2000BLib = cdll.LoadLibrary(DLL_PATH)
